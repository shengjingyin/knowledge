				...
				},
				{
					...
					children: [
						...
						{ text: "TS中的型变", link: "/front/typescript/TS中的型变" },
						{
							...
							collapsible: true,
							children: [
								{ text: "一、TS支持哪些运算", link: "/front/typescript/TS类型体操/一、TS支持哪些运算" },
								{ text: "二、模式匹配做提取", link: "/front/typescript/TS类型体操/二、模式匹配做提取" },
							],
						},
					],
				},
					...
					children: [
						{
							...
							children: [
								...
								{ text: "反转字符串中的元音字母", link: "/coding/算法/字符串/反转字符串中的元音字母" },
						...
						},
						{
							...
							children: [
								...
								{ text: "获取生成数组中的最大值", link: "/coding/算法/数组/获取生成数组中的最大值" },
							],
						},
